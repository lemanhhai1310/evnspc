    ...
    <div class="uk-container">
        <div class="uk-grid uk-flex-center">
            <div class="uk-width-2-5@s">
                <ul class="tab_acc uk-subnav uk-subnav-pill uk-child-width-expand uk-margin-remove" uk-switcher>
                    <li class="uk-padding-remove uk-active"><a href="#">đăng nhập</a></li>
                    <li class="uk-padding-remove"><a href="#">đăng ký</a></li>
                </ul>
                        ...
                        <form class="form_acc">
                            ...
                            <div class="uk-margin-small">
                                <div class="uk-position-relative">
                                    ...
                                    <input id="password-field" class="uk-input" name="password" type="password" placeholder="Mật khẩu" value="hai.lemanh.1310">
                                    <span toggle="#password-field" class="fa fa-eye toggle-password uk-position-center-right unlock_pass" style="right: 15px;"></span>
                                </div>
                            </div>
                            <div class="uk-margin-small">
                                <p class="error1">* Tên đăng nhập hoặc mật khẩu bạn nhập không chính xác</p>
                            </div>
